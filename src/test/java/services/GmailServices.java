...
public class GmailServices {
    ...
    public void getGmailList() throws ConfigurationException, org.apache.commons.configuration.ConfigurationException, IOException {
    ...
    public String readLatestEmail() throws IOException, org.apache.commons.configuration.ConfigurationException, ConfigurationException {
        //Read Gmail First
        getGmailList();
